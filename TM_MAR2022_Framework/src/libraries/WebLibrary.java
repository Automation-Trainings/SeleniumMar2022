...
public class WebLibrary extends DriverClass {
	...
	/*
	 * Method Name : Validate Text
	 * 
	 * Description : This method is used to verify the text/label
	 * 
	 * Input: driver
	 * 
	...
	public boolean selectByVisibleText(WebElement element, Object leaveType) {
...
////				.findElement(By.xpath("//*[@id='applyleave_txtLeaveType']/option[text()='" + leaveType + "']"));
	 ...
	 * 
	 */
	public boolean SetTextAndEscape(WebElement element, Object text) {
